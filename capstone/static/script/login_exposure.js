...
document.getElementById("sde3").addEventListener("click", function(){
	document.getElementById('UsernameInput').value = "' or 1=1 UNION SELECT user, id, balance, password FROM accounts_unencrypted;#";
	document.getElementById('dbToken').value = "1";
});

document.getElementById("sde4").addEventListener("click", function(){
	document.getElementById('UsernameInput').value = "' or 1=1 UNION SELECT user, id, balance, encrypted_password FROM accounts_base64;#";
	document.getElementById('dbToken').value = "1";
});

document.getElementById("sde5").addEventListener("click", function(){
